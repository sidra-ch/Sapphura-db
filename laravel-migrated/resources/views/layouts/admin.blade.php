    ...
    <aside :class="sidebarOpen ? 'w-64' : 'w-16'" class="bg-ink border-r border-gold/10 min-h-screen transition-all duration-300 flex flex-col">
        ...
        <nav class="flex-1 py-4 space-y-1">
            ...
            @foreach([
                ...
                ['admin/media-library', 'Media Library', 'M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z'],
