@extends('layouts.app')
@section('title', 'Sapphura â€“ Luxury Fashion & Jewelry')

@section('content')

{{-- â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
     HERO â€” Cinematic editorial, minimal
â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• --}}
...
<section class="border-b border-gold/[0.08] bg-ink py-14 md:py-16">
    <div class="section-shell">
        ...
        <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            @foreach([
                ['icon' => 'â™›', 'title' => 'Navy & Gold Identity', 'desc' => 'A refined color system that signals trust, elegance, and premium quality across every touchpoint.'],
                ['icon' => 'âœ¦', 'title' => 'Signature Aesthetics', 'desc' => 'Subtle gradients, gold accents, and quiet details that enhance product focus without distraction.'],
                ['icon' => 'âš¡', 'title' => 'Premium Delivery', 'desc' => 'Nationwide shipping with careful packaging designed to make unboxing feel like unwrapping a gift.'],
                ['icon' => 'ðŸ›¡', 'title' => 'Trusted Quality', 'desc' => 'Every piece is quality-checked and backed by a satisfaction guarantee with easy exchange support.'],
            ] as $feature)
    ...
    <div class="section-shell">
        ...
        <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            @foreach([
                ...
                ['name' => 'Stitch Suits', 'img' => '/stitch suit/img-1.jpeg', 'tag' => 'Premium &middot; Embroidered &middot; Eid'],
...
{{-- â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
     EID UL ADHA â€” Festival editorial section
â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• --}}
    ...
    <div class="section-shell">
        ...
        <div class="flex flex-col gap-3 lg:flex-row lg:gap-4">
            ...
            <div class="relative overflow-hidden rounded-2xl lg:w-[38%] lg:flex-shrink-0"
                ...
                <video src="/stitch suit/latest-vid1.mp4" autoplay muted loop playsinline preload="metadata"
                       class="h-full w-full object-cover"
            ...
            <div class="grid grid-cols-2 gap-3 lg:flex-1 lg:gap-4">
                @foreach(['/stitch suit/img-1.jpeg', '/stitch suit/img-2.jpeg', '/stitch suit/img-3.jpeg', '/stitch suit/img-4.jpeg'] as $stitchImg)
        ...
        <div class="grid gap-8 lg:grid-cols-2">
            ...
            <div class="flex flex-col justify-center">
                <div class="glass rounded-2xl p-8 md:p-10">
                    ...
                    <form class="mt-6 space-y-3" onsubmit="event.preventDefault(); this.querySelector('button').textContent='Subscribed âœ“';">
                    ...
                    <p class="mt-3 text-[10px] text-cream/30 uppercase tracking-[0.14em]">No spam â€” just curated luxury updates.</p>
                </div>
            </div>
        </div>
    </div>
