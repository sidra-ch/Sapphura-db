    ...
    <div class="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
        <div class="relative flex items-center justify-between h-[60px] sm:h-[68px] lg:h-[78px]">
            ...
            <div class="flex items-center gap-3.5 sm:gap-4">
                <a href="/search" class="text-cream/80 hover:text-gold transition p-3 rounded-full hover:bg-gold/10" title="Search">
                ...
                @auth
                    <a href="/account" class="text-cream/80 hover:text-gold transition p-3 rounded-full hover:bg-gold/10" title="Account">
