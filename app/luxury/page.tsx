  ...
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top,rgba(18,37,76,0.95),rgba(8,12,24,1)_58%)] text-white">
      <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <Link
          href="/"
          className="inline-flex items-center gap-2 rounded-full border border-[#d4af37]/25 bg-white/5 px-4 py-2 text-sm uppercase tracking-[0.22em] text-[#dbc6a4] transition hover:border-[#d4af37]/45 hover:bg-[#d4af37] hover:text-[#09111f]"
        >
        ...
        <div className="mt-8 grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
          <div>
            ...
            <AnimatePresence mode="wait">
              ...
              >
                <h1 className="mt-4 max-w-3xl text-4xl font-semibold leading-tight text-[#fff7ef] sm:text-5xl lg:text-6xl">
                  {chapter.title}
                </h1>
                ...
                <div className="mt-8 flex flex-wrap gap-3">
                  {chapter.highlights.map((item) => (
                    <span
                      key={item}
                      className="rounded-full border border-[#d4af37]/18 bg-white/5 px-4 py-2 text-xs uppercase tracking-[0.22em] text-[#dbc6a4]"
                    >
                      {item}
                    </span>
                  ))}
                ...
                <div className="mt-8 flex flex-wrap gap-4">
                  <Link
                    href="/collections"
                    className="inline-flex items-center gap-2 rounded-full bg-[#d4af37] px-6 py-3 text-sm font-semibold uppercase tracking-[0.22em] text-[#09111f] transition hover:bg-[#e6c45a]"
                  >
                    Explore Collections
                  ...
                  <Link
                    href="/about"
                    className="inline-flex items-center gap-2 rounded-full border border-[#d4af37]/25 px-6 py-3 text-sm font-semibold uppercase tracking-[0.22em] text-[#dbc6a4] transition hover:border-[#d4af37]/45 hover:bg-white/5 hover:text-[#fff7ef]"
                  >
        ...
        <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-4">
          {featureCards.map((card) => {
            ...
            return (
              <article
                key={card.title}
                className="rounded-[24px] border border-[#d4af37]/12 bg-[linear-gradient(180deg,rgba(17,30,60,0.7),rgba(9,17,31,0.94))] p-6 text-[#fff7ef]"
              >
                <div className="inline-flex rounded-2xl bg-[#d4af37]/10 p-3 text-[#d4af37]">
