...
export function generateMetadata(): Metadata {
  return {
    ...
    openGraph: {
      ...
      images: [
        {
          url: 'https://res.cloudinary.com/dwmxdyvd2/image/upload/v1/sapphura/og-image.jpg',
          width: 1200,
          height: 630,
    ...
    twitter: {
      ...
      title: 'Sapphura | Luxury Ecommerce',
      description: 'Shop luxury products at Sapphura. Discover exclusive collections, premium brands, and seamless shopping experience.',
      images: ['https://res.cloudinary.com/dwmxdyvd2/image/upload/v1/sapphura/og-image.jpg'],
    },
  };
}
