    ...
    <main className="min-h-screen flex items-center justify-center bg-[#0a0a23]">
      <div className="bg-[#1a1a40] border border-gold rounded-xl p-10 shadow-lg w-full max-w-md">
        <h1 className="text-3xl font-bold text-gold mb-8 flex items-center gap-3">
          <Lock className="w-7 h-7 text-gold" /> Admin Login
        </h1>
        <form className="space-y-6">
          <div>
            <label className="block text-gold mb-2">Email</label>
            <input type="email" className="w-full px-4 py-3 rounded-lg bg-[#0a0a23] border border-gold text-white focus:outline-none focus:border-yellow-400" placeholder="admin@example.com" />
          </div>
          <div>
        ...
        <div className="mt-6 text-center">
          <Link href="/">
            <span className="text-gold hover:text-yellow-300 transition">Back to Home</span>
          </Link>
        </div>
      </div>
    </main>
